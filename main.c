...
static float dens_prev_buf[(N_sim+1) * (N_sim+1)] = {0};
static float dens_buf[(N_sim+1) * (N_sim+1)] = {0};
static float u_prev_buf[(N_sim+1) * (N_sim+1)] = {0};
static float u_buf[(N_sim+1) * (N_sim+1)] = {0};
static float v_prev_buf[(N_sim+1) * (N_sim+1)] = {0};
static float v_buf[(N_sim+1) * (N_sim+1)] = {0};
...
static float src_dens_buf[(N_sim+1) * (N_sim+1)] = {0};
static float src_u_buf[(N_sim+1) * (N_sim+1)] = {0};
static float src_v_buf[(N_sim+1) * (N_sim+1)] = {0};
